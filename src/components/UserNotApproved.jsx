  ...
  return (
    <div className={styles.container}>
      ...
      <div>
          ...
          <div>
            <div>
              ...
              <p>
                ...
                para confirmar su información, lo que se notificará a través de
                correo electrónico.
                <br />
                <br /> Si la situación persiste, comunicarse a través del correo
                electrónico <span>sistemas@bethacorp07.com</span>
              </p>
            </div>
          </div>
          <div>
        ...
        <div>
          <a href="https://www.bethacorp07.com">Volver a la pagina principal</a>
        </div>
      </div>
    </div>
  );
